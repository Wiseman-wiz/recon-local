...
class Segregator:
    ...
    def match_keywords(self, match_fields: dict):
        ...
        strd_field_names["strd_trn_ref"] = "transaction_reference"
        strd_field_names["strd_cr_amt"] = "credit_amount"
        strd_field_names["strd_dr_amt"] = "debit_amount"
        strd_field_names["strd_trn_date"] = "transaction_date"
    ...
    def segregation(self):
        ...
        if not gl_df_before.empty:
            fucking_gl = gl_df[(gl_df["approved"] == "approved" )& (gl_df["is_matched"] == False)].to_dict()

        if not bs_df_before.empty:
            fucking_bs = bs_df[(bs_df["approved"] == "approved" )& (bs_df["is_matched"] == False)].to_dict()
        ...
        return {
            ...
            "recon_items_unmatched_bs_cols": fucking_gl,
            "recon_items_unmatched_gl_cols": fucking_bs
        }
    ...
    def get_time_range(self, gl_df, bs_df):
        try:
            ...
            gl_df = gl_df[gl_df["transaction_date"].between(self.from_date, self.to_date)]
